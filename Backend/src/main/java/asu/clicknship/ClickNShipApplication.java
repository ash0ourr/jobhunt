...
public class ClickNShipApplication {

    public static void main(String[] args) {
        SpringApplication.run(ClickNShipApplication.class, args);
        System.out.println("Let's Start the project!");
    }
